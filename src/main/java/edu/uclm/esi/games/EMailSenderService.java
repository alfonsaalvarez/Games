...
public class EMailSenderService {
	...
	public void enviarPorGmail(String destinatario, String codigo) throws MessagingException {
		...
		this.startTTLS="true";
		this.port="465";
		this.remitente="game2019macario@gmail.com";
		this.serverUser="game2019macario@gmail.com";
		this.userAutentication="true";
		this.pwd="macario2019";
		...
		msg.setText("Su token es el siguiente:code=" + codigo
				+ "\n Pulsa en el siguiente enlace para crear una nueva contraseña: http://localhost:8080/nuevaPWDEmail.html?code=" + codigo);
